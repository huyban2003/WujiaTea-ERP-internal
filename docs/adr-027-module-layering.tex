% ADR-027 bản độc lập — build: lualatex adr-027-module-layering.tex (2 lần)
...
\title{\vspace{1cm}\textbf{WujiaTea Odoo 19}\\[0.3cm]\large ADR-027 --- Kiến trúc tầng module \& Mobile core\\[0.2cm]\large Đã chốt 2026-09-26 --- áp dụng khối A (F7--F13)}
\author{Dev Team \\ \texttt{huyban.han@gmail.com}}
\date{đề xuất 2026-09-17 · chốt 2026-09-26}
\begin{document}
\maketitle
\tableofcontents
