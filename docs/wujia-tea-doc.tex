...
\begin{itemize}
    ...
    \item Pop-up chọn cửa hàng đăng nhập (BA spec mục \emph{Giao diện chung}) cho user multi-franchise như \texttt{dung.multi}.
...
# Install toàn bộ Portal Phase 1.0 (Sprint 4)
