...
\item Sửa tham chiếu \texttt{wujia\_portal\_<x>.\ldots} ở module khác, cùng manifest và
  ...
  đổi chủ xmlid xong thì \texttt{ref} ở đó gãy lúc \texttt{-u}. Chốt trước khi làm F8/F12: sửa
  nguồn mobile (bàn giao) hay giữ xmlid cũ (dòng \texttt{ir\_model\_data} thứ hai trỏ cùng
  \texttt{res\_id}) --- chưa quyết.
