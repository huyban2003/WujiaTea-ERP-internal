...
| F8 | Tách một phần `info_request` → `wujia_info_request` + controller mỏng | info_request, portal_info_request (+ mobile Thái 5 dòng) | Cao | ✅ 26/09 — `docs/f8-acceptance-matrix.md` (9/9), 5 dòng mobile Thái sửa theo duyệt; `a5cb738`, chưa deploy |
