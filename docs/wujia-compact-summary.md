...
→ Chi tiết: `chapters/04-17.tex` + `chapters/18-sprint9-issue-list-ui-refactor.tex` (cuối Sprint 9) + `chapters/19-sprint10-mobile-home-figma.tex` + `chapters/20-sprint11-mobile-order.tex`.
