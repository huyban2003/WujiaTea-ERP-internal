...
LAYER = {
    'wujia_core': CORE,
    'wujia_sale': BIZ, 'wujia_order_window': BIZ, 'wujia_info_request': BIZ, 'wujia_knowledge': BIZ, 'wujia_support': BIZ, 'wujia_notification': BIZ, 'wujia_exam': BIZ, 'wujia_fleet': BIZ, 'wujia_delivery': BIZ, 'wujia_account': BIZ,
