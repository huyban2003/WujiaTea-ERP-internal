...
patch(MenuDropdown.prototype,{
    ...
    addIcons(){
        ...
        if( menuName && this.dnMenuRef.el && this?.env.services.menu.getCurrentApp?.().xmlid === "wj_ks_dashboard_ninja.board_menu_root"){
...
patch(NavBar.prototype,{
    ...
    async adapt(){
        if(this.currentApp?.xmlid === "wj_ks_dashboard_ninja.board_menu_root" || this.actionService?.currentController?.action.tag === 'wj_ks_dashboard_ninja'){
    ...
    onNavBarDropdownItemSelection(menu) {
        if(this.currentApp?.xmlid === "wj_ks_dashboard_ninja.board_menu_root"){
...
patch(ActionContainer.prototype,{
    setup(){
        super.setup();
        onPatched( () => {
                if(this?.env.services.menu.getCurrentApp?.()?.xmlid === "wj_ks_dashboard_ninja.board_menu_root" || this.info?.componentProps?.action?.tag === 'wj_ks_dashboard_ninja'){
                    if(!document.querySelector('body').classList.contains('ks_body_class'))
                        dnNavBarAddClasses();
                }
                else if(this?.env.services.menu.getCurrentApp?.()?.xmlid !== "wj_ks_dashboard_ninja.board_menu_root" || this.info?.componentProps?.action?.tag !== 'wj_ks_dashboard_ninja'){
                    if(document.querySelector('body').classList.contains('ks_body_class'))
                        dnNavBarRemoveClasses();
                }
        });
