   ...
   changeIcons(){
        ...
        if(ks_upload_parent_field_el){
            ...
            if(pencil_icon_btn){
                ...
                pencil_icon_btn.innerHTML += renderToString("wj_ks_dashboard_ninja.edit_svg", {})
            }
            if(download_icon_btn){
                download_icon_btn.classList.remove('fa', 'fa-download')
                download_icon_btn.innerHTML += renderToString("wj_ks_dashboard_ninja.trash_svg", {})
            }
            if(trash_icon_btn){
                trash_icon_btn.classList.remove('fa', 'fa-trash')
                trash_icon_btn.innerHTML += renderToString("wj_ks_dashboard_ninja.download_svg", {})
            }
        }
   },
});